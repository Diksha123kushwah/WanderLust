...
function mn() {
  if (typeof navigator > "u") {
    const e = Intl.DateTimeFormat().resolvedOptions().locale.split("-")[0], t = dn(e);
    return t || R.ENGLISH;
  }
  return Array.from(new Set(navigator.languages.map((e) => e.split("-")[0]))).map((e) => dn(e)).filter((e) => e)[0] ?? R.LOCAL;
}
const V = {
...
function wn(r) {
  return (e, t) => {
    if (r != null) {
      const n = r(e, t), a = bn((n == null ? void 0 : n.url) ?? "", t);
      return {
        ...n,
        ...a
      };
  ...
  const n = structuredClone(r), a = (o) => {
    if (typeof o != "string")
      for (let i = 0; i < o.length; i += 1)
        Sn(o[i], t) ? o[i] = structuredClone(e) : a(o[i]);
  };
  return Sn(n, t) ? e : (a(n), n);
}
function Zo(r, e) {
...
class ac extends k.Style {
  constructor(e, t = {}) {
    super(e, t);
  }
}
class oc extends k.CanvasSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class ic extends k.GeoJSONSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class sc extends k.ImageSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class lc extends k.RasterTileSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class uc extends k.RasterDEMTileSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class cc extends k.VectorTileSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class pc extends k.VideoSource {
  onAdd(e) {
    super.onAdd(e);
  }
}
class ti extends k.NavigationControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class ri extends k.GeolocateControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class fc extends k.AttributionControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class ni extends k.LogoControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class ai extends k.ScaleControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class oi extends k.FullscreenControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class dc extends k.TerrainControl {
  onAdd(e) {
    return super.onAdd(e);
  }
}
class hc extends k.BoxZoomHandler {
  constructor(e, t) {
    super(e, t);
  }
}
...
class mc extends k.CooperativeGesturesHandler {
  constructor(e, t) {
    super(e, t);
  }
}
class gc extends k.KeyboardHandler {
  constructor(e) {
    super(e);
  }
}
class vc extends k.TwoFingersTouchPitchHandler {
  constructor(e) {
    super(e);
  }
}
class bc extends k.MapWheelEvent {
  constructor(e, t, n) {
    super(e, t, n);
  }
}
class wc extends k.MapTouchEvent {
  constructor(e, t, n) {
    super(e, t, n);
  }
}
class Sc extends k.MapMouseEvent {
  constructor(e, t, n, a = {}) {
    super(e, t, n, a);
  }
}
...
var ii = 8, si = {
  ...
  source_vector: ci,
  source_raster: pi,
  source_raster_dem: fi,
  source_geojson: di,
  source_video: hi,
  source_image: yi,
  layer: mi,
  layout: gi,
  layout_background: vi,
  layout_fill: bi,
  layout_circle: wi,
  layout_heatmap: Si,
  "layout_fill-extrusion": {
...
const ha = 0.96422, ya = 1, ma = 0.82521, ga = 4 / 29, qe = 6 / 29, va = 3 * qe * qe, Zi = qe * qe * qe, Wi = Math.PI / 180, Yi = 180 / Math.PI;
function ba(r) {
...
function Ji(r) {
  ...
  return [Math.round(o * 1e4) ? ba(Math.atan2(n, t) * Yi) : NaN, o, e, a];
}
function Qi([r, e, t, n]) {
...
class $ {
   ...
   */
  get hcl() {
    return this.overwriteGetter("hcl", Ji(this.rgb));
  }
  /**
   * Used in color interpolation.
   *
...
class me {
  ...
  static fromString(e) {
    return new me([new Cr(e, null, null, null, null, null)]);
  }
  isEmpty() {
...
const os = /* @__PURE__ */ new Set(["center", "left", "right", "top", "bottom", "top-left", "top-right", "bottom-left", "bottom-right"]);
class ue {
  constructor(e) {
    this.values = e.slice();
  }
  static parse(e) {
    ...
    if (!(!Array.isArray(e) || e.length < 1 || e.length % 2 !== 0)) {
      for (let t = 0; t < e.length; t += 2) {
        const n = e[t], a = e[t + 1];
        if (typeof n != "string" || !os.has(n) || !Array.isArray(a) || a.length !== 2 || typeof a[0] != "number" || typeof a[1] != "number")
          return;
      }
      return new ue(e);
    }
...
const is = ["Unknown", "Point", "LineString", "Polygon"];
class ka {
  constructor() {
  ...
  geometryType() {
    return this.feature ? typeof this.feature.type == "number" ? is[this.feature.type] : this.feature.type : null;
  }
  geometry() {
...
class Gr {
  ...
  static parse(e, t) {
    ...
    return !l || s.type.kind !== "value" && t.concat(1).checkSubtype(n, s.type) ? null : new Gr(n, a, s, o, i, l);
  }
  evaluate(e) {
...
class Kr {
  ...
  evaluate(e) {
    const t = (n) => {
      ...
      return B(a) === ft ? new Cr("", a, null, null, null, n.verticalAlign ? n.verticalAlign.evaluate(e) : null) : new Cr(tt(a), null, n.scale ? n.scale.evaluate(e) : null, n.font ? n.font.evaluate(e).join(",") : null, n.textColor ? n.textColor.evaluate(e) : null, n.verticalAlign ? n.verticalAlign.evaluate(e) : null);
    };
...
class Xr {
  ...
  static parse(e, t) {
    ...
    return n ? new Xr(n) : t.error("No image name provided.");
  }
  evaluate(e) {
...
function Ds(r, e) {
  ...
  if (e.type === "Polygon") {
    const o = Yr(e.coordinates, n, a), i = _n(r.geometry(), t, n, a);
    if (!st(t, n))
      return !1;
    for (const s of i)
      if (!Ze(s, o))
  ...
  if (e.type === "MultiPolygon") {
    const o = Ta(e.coordinates, n, a), i = _n(r.geometry(), t, n, a);
    if (!st(t, n))
      return !1;
    for (const s of i)
      if (!$s(s, o))
...
function Us(r, e) {
  const t = [1 / 0, 1 / 0, -1 / 0, -1 / 0], n = [1 / 0, 1 / 0, -1 / 0, -1 / 0], a = r.canonicalID();
  if (e.type === "Polygon") {
    const o = Yr(e.coordinates, n, a), i = In(r.geometry(), t, n, a);
    if (!st(t, n))
      return !1;
    for (const s of i)
      if (!Ea(s, o))
...
const Gs = 6378.137, Mn = 1 / 298.257223563, Pn = Mn * (2 - Mn), Rn = Math.PI / 180;
class Jr {
  constructor(e) {
    const t = Rn * Gs * 1e3, n = Math.cos(e * Rn), a = 1 / (1 - Pn * (1 - n * n)), o = Math.sqrt(a);
    this.kx = t * o * n, this.ky = t * o * a * (1 - Pn);
  }
  /**
...
function $n(r, e, t, n, a, o) {
  if (!o)
    return;
  const i = Qr(Tr(n, o), a, t);
  i < e && r.push([i, o, [0, 0]]);
}
...
function Pt(r, e, t, n, a = 1 / 0) {
  ...
  if (o === 0)
    return o;
  const i = new Ia([[0, [0, r.length - 1], [0, 0]]], Ma), s = _r(t);
  for (; i.length > 0; ) {
    const l = i.pop();
    if (l[0] >= o)
      continue;
    ...
    if (Mt(u) <= c) {
      ...
      const p = Er(u, e);
      $n(i, o, n, r, s, p[0]), $n(i, o, n, r, s, p[1]);
    }
  }
  return o;
}
...
function Js(r, e) {
  ...
  if (t.length === 0 || t[0].length === 0)
    return NaN;
  const n = Bs(t).map((i) => i.map((s) => s.map((l) => Wr([l.x, l.y], r.canonical)))), a = new Jr(n[0][0][0][1]);
  let o = 1 / 0;
  for (const i of e)
    for (const s of n) {
      switch (i.type) {
...
class le {
  ...
  static parse(e, t) {
    ...
    if (s.length === 1)
      ...
      const c = (s.length ? s : i).map(([f]) => el(f)).join(" | "), p = [];
...
class tl {
  constructor(e, t) {
    this.expression = e, this._warningHistory = {}, this._evaluator = new ka(), this._defaultValue = t ? al(t) : null, this._enumValues = t && t.type === "enum" ? t.values : null;
  }
...
class Dn {
  constructor(e, t, n, a) {
    this.kind = e, this.zoomStops = n, this._styleExpression = t, this.isStateDependent = e !== "camera" && !lt(t.expression), this.globalStateRefs = nn(t.expression), this.interpolationType = a;
  }
  evaluateWithoutErrorHandling(e, t, n, a, o, i) {
    return this._styleExpression.evaluateWithoutErrorHandling(e, t, n, a, o, i);
  }
...
function nn(r, e = /* @__PURE__ */ new Set()) {
...
const Bn = {
  ...
  numberArray: pl,
  colorArray: fl,
  variableAnchorOffsetCollection: dl,
  sprite: Xa,
  state: Za
};
function $t(r) {
...
class Sl {
  constructor() {
    ...
    Go(["_toggleTerrain", "_updateTerrainIcon"], this);
  }
  onAdd(e) {
  ...
  onRemove() {
    sn(this._container), this._map.off("terrain", this._updateTerrainIcon), this._map = void 0;
  }
  _toggleTerrain() {
...
const Gn = k.Marker, Vn = k.LngLat, kl = k.LngLatBounds;
class Cl extends ri {
  constructor() {
    super(...arguments);
    S(this, "lastUpdatedCenter", new Vn(0, 0));
    /**
    ...
    S(this, "_updateCamera", (t) => {
      var c;
      const n = new Vn(t.coords.longitude, t.coords.latitude), a = t.coords.accuracy, i = {
        bearing: this._map.getBearing(),
        ...this.options.fitBoundsOptions,
        linear: !0
      }, s = this._map.getZoom();
      s > (((c = this.options.fitBoundsOptions) == null ? void 0 : c.maxZoom) ?? 30) && (i.zoom = s), this._map.fitBounds(kl.fromLngLat(n, a), i, {
        geolocateSource: !0
    ...
    S(this, "_finishSetupUI", (t) => {
      if (this._map) {
        ...
        this.options.trackUserLocation && (this._geolocateButton.setAttribute("aria-pressed", "false"), this._watchState = "OFF"), this.options.showUserLocation && (this._dotElement = ge("div", "maplibregl-user-location-dot"), this._userLocationDotMarker = new Gn({ element: this._dotElement }), this._circleElement = ge("div", "maplibregl-user-location-accuracy-circle"), this._accuracyCircleMarker = new Gn({
...
class Ll {
  ...
  onRemove() {
    sn(this.container), this.map.off("projectiontransition", this.updateProjectionIcon), this.map = void 0;
  }
  toggleProjection() {
...
function Qn({ gl: r, type: e, source: t }) {
...
function au({ gl: r, vertexShaderSource: e, fragmentShaderSource: t }) {
  const n = Qn({
    gl: r,
    type: r.VERTEX_SHADER,
    source: e
  }), a = Qn({ gl: r, type: r.FRAGMENT_SHADER, source: t }), o = r.createProgram();
...
function to({
  ...
  const s = au({ gl: r, vertexShaderSource: e, fragmentShaderSource: t }), l = n.reduce((d, h) => (d[h] = r.getAttribLocation(s, `a_${h}`), d), {}), u = a.reduce((d, h) => (d[h] = ou(r, s, `u_${h}`), d), {}), c = r.createBuffer();
...
function At(r) {
  ...
  if (r === "transparent")
    return [1, 1, 1, 0];
  try {
    const e = iu(r), t = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})?$/i.exec(e);
    if (t != null && t.length) {
      const a = !!t[4];
      return [...nu.hex.rgb(e).map((o) => o / 255), a ? parseInt(t[4], 16) / 255 : 1];
    }
...
const ln = 1, re = ln / 2, ne = ln / 2, ae = ln / 2, su = [-0.5, -0.5, ae, re, -0.5, ae, re, ne, ae, -0.5, ne, ae], lu = [-0.5, -0.5, -0.5, -0.5, ne, -0.5, re, ne, -0.5, re, -0.5, -0.5], uu = [-0.5, ne, -0.5, -0.5, ne, ae, re, ne, ae, re, ne, -0.5], cu = [-0.5, -0.5, -0.5, re, -0.5, -0.5, re, -0.5, ae, -0.5, -0.5, ae], pu = [re, -0.5, -0.5, re, ne, -0.5, re, ne, ae, re, -0.5, ae], fu = [-0.5, -0.5, -0.5, -0.5, -0.5, ae, -0.5, ne, ae, -0.5, ne, -0.5], du = [...su, ...lu, ...uu, ...cu, ...pu, ...fu], hu = [
  ...
  22,
  23
], yu = `attribute vec3 a_vertexPosition;
...
class br {
  ...
  animateColorChange() {
    const e = () => {
      this.transitionDelta < 1 && (requestAnimationFrame(e), this.bgColor = bu(this.previousBgColor, this.targetBgColor, this.transitionDelta), this.transitionDelta += 0.075, this.map.triggerRepaint());
    };
  ...
  render(e, t) {
    ...
    Wl(u, l, i, n, a), Kn(u, u, s.rollInRadians), Hn(u, u, -s.pitchInRadians), Kn(u, u, s.bearingInRadians);
    const c = s.center.lat * Math.PI / 180, p = s.center.lng * Math.PI / 180;
    Hn(u, u, c), Xl(u, u, -p), e.uniformMatrix4fv(this.cubemap.programInfo.uniformsLocations.projectionMatrix, !1, u);
    const f = rt();
...
function aa(r) {
  ...
  if (r.preset)
    return {
      pX: `${De}/${r.preset}/px.webp`,
      nX: `${De}/${r.preset}/nx.webp`,
      pY: `${De}/${r.preset}/py.webp`,
      nY: `${De}/${r.preset}/ny.webp`,
      pZ: `${De}/${r.preset}/pz.webp`,
      nZ: `${De}/${r.preset}/nz.webp`
    };
  if (r.path) {
...
const Lu = `attribute vec3 a_position;
...
class wr {
   ...
   */
  async setGradient(e) {
    await this.animateOut(), this.gradient = e, await this.animateIn();
  }
  show() {
    this.map.setLayoutProperty(this.id, "visibility", "visible");
  }
...
let Mu = class ro extends k.Map {
  constructor(t) {
    ...
    const { style: n, requiresUrlMonitoring: a, isFallback: o } = qn(t.style);
    o && console.warn(
    ...
    }), D.caching && !kr && console.warn("The cache API is only available in secure contexts. More info at https://developer.mozilla.org/en-US/docs/Web/API/Cache"), D.caching && kr && Bo(), typeof t.language > "u")
      this.primaryLanguage = D.primaryLanguage;
    else {
      const h = hn(t.language, R);
    ...
    this.forceLanguageUpdate = !(this.primaryLanguage === R.STYLE || this.primaryLanguage === R.STYLE_LOCK), this.languageAlwaysBeenStyle = this.primaryLanguage === R.STYLE, this.terrainExaggeration = t.terrainExaggeration ?? this.terrainExaggeration, this.curentProjection = t.projection, this.on("styledata", () => {
      ...
      if (t.forceNoAttributionControl !== !0)
        if ("logo" in h && h.logo) {
          const y = h.logo;
          this.addControl(new xn({ logoURL: y }), t.logoPosition);
  ...
  initHalo({ options: t = this.options, before: n, spec: a }) {
    ...
    const o = a;
    if (t.halo) {
      this.halo = new wr(t.halo), this.addLayer(this.halo, n);
      return;
    }
    o && (this.halo = new wr(o), this.addLayer(this.halo, n));
  }
  getHalo() {
    return this.halo;
  }
  setHalo(t) {
    if (this.isGlobeProjection()) {
      ...
      this.halo = new wr(t), this.once("load", () => {
        var s;
  ...
  getStyleLanguage() {
    return !this.style || !this.style.stylesheet || !this.style.stylesheet.metadata || typeof this.style.stylesheet.metadata != "object" ? null : "maptiler:language" in this.style.stylesheet.metadata && typeof this.style.stylesheet.metadata["maptiler:language"] == "string" ? Po(this.style.stylesheet.metadata["maptiler:language"]) : null;
  }
  /**
  ...
  setPrimaryLanguage(t) {
    const n = this.getStyleLanguage(), a = hn(t, R);
    if (!a) {
    ...
    o.flag === R.VISITOR.flag ? (i = mn().flag, s = [
      "case",
...
`, ["get", R.LOCAL.flag], { "font-scale": 1.1 }]
      ...
      ["get", R.LOCAL.flag]
    ]) : o.flag === R.AUTO.flag ? (i = mn().flag, s = ["coalesce", ["get", i], ["get", R.LOCAL.flag]]) : o === R.LOCAL ? (i = R.LOCAL.flag, s = ["get", i]) : (i = o.flag, s = ["coalesce", ["get", i], ["get", R.LOCAL.flag]]);
  ...
  getCameraHash() {
    ...
    return t[0] = n.lng, t[1] = n.lat, t[2] = this.getZoom(), t[3] = this.getPitch(), t[4] = this.getBearing(), Fo.fromUint8Array(new Uint8Array(t.buffer));
  }
  /**
...
function ao(r) {
  const e = typeof r == "string" ? un(r) : r;
  if (!no(e, "gpx"))
  ...
  for (const i of Array.from(a))
    o.features.push(Ou(i));
  return o;
}
function oo(r, e) {
  let t = r;
  if (typeof t == "string" && (t = un(t)), !no(t, "kml"))
  ...
  for (const c of Array.from(u)) {
    a[`#${Oe(c, "id")}`] = ua(e !== void 0 ? e(c) : sa(c)).toString(16);
    const p = G(c, "Pair"), f = {};
  ...
  for (const c of Array.from(s))
    n.features = n.features.concat(zu(c, a, o, i));
  return n;
}
function la(r) {
    ...
    if (n = G(r, e[a]), n) {
      for (o = 0; o < n.length; o++)
        if (t = n[o], e[a] === "Point")
          s.push({
            type: "Point",
            coordinates: uo(O(E(t, "coordinates")) ?? "")
          });
...
function Fu(r) {
  ...
  for (let s = 0; s < e.length; s++)
    if (o = io(e[s], "trkpt"), o !== void 0 && (o.line && t.push(o.line), o.times && o.times.length && n.push(o.times), a.length || o.heartRates && o.heartRates.length)) {
      if (!a.length)
        for (let l = 0; l < s; l++)
...
function cn(r) {
  const e = Pr(r, ["name", "cmt", "desc", "type", "time", "keywords"]), t = G(r, "link");
  if (t.length !== 0) {
    e.links = [];
...
async function Du(r, e = {}) {
  const t = e.download ?? !1, n = await Uu(r);
  if (t) {
...
function po(r, e) {
  ...
  if (Array.isArray(r) && Array.isArray(e)) {
    ...
    return ["interpolate", ["linear"], ["zoom"], ...t.flatMap((n) => [n, 2 * zr(e, n) + zr(r, n)])];
  }
  return 0;
}
function fo(r, e) {
...
function Hu(r, e) {
  ...
  if (a) {
    ...
    if (e.property && Array.isArray(e.pointColor)) {
      const Te = Array.from({ length: o }, (We, gt) => {
...
function Ku(r, e) {
  ...
  let l = Array.isArray(e.colorRamp) ? e.colorRamp : mo.TURBO.transparentStart();
  const u = l.getBounds();
...
const Cc = k.Map, Lc = k.Marker, Ac = k.Popup, Ec = k.Style, Tc = k.CanvasSource, _c = k.GeoJSONSource, Ic = k.ImageSource, Mc = k.RasterTileSource, Pc = k.RasterDEMTileSource, Rc = k.VectorTileSource, zc = k.VideoSource, Fc = k.NavigationControl, $c = k.GeolocateControl, Oc = k.AttributionControl, jc = k.LogoControl, Nc = k.ScaleControl, Dc = k.FullscreenControl, Uc = k.TerrainControl, Bc = k.BoxZoomHandler, qc = k.ScrollZoomHandler, Gc = k.CooperativeGesturesHandler, Vc = k.KeyboardHandler, Hc = k.TwoFingersTouchPitchHandler, Kc = k.MapWheelEvent, Xc = k.MapTouchEvent, Zc = k.MapMouseEvent, Wc = k.config, Yc = k.getVersion, {
  ...
  LngLat: ep,
  LngLatBounds: tp,
  MercatorCoordinate: rp,
  Evented: np,
  AJAXError: ap,
  prewarm: op,
  clearPrewarmedResources: ip,
  Hash: sp,
  Point: lp,
  EdgeInsets: up,
  DragRotateHandler: cp,
  DragPanHandler: pp,
  TwoFingersTouchZoomRotateHandler: fp,
  DoubleClickZoomHandler: dp,
  TwoFingersTouchZoomHandler: hp,
  TwoFingersTouchRotateHandler: yp,
  getWorkerCount: mp,
  setWorkerCount: gp,
  getMaxParallelImageRequests: vp,
  setMaxParallelImageRequests: bp,
  getWorkerUrl: wp,
  setWorkerUrl: Sp,
  addSourceType: xp,
  importScriptInWorkers: kp,
  addProtocol: Cp,
  removeProtocol: Lp
} = k;
export {
  ap as AJAXError,
  fc as AttributionControl,
  Oc as AttributionControlMLGL,
  hc as BoxZoomHandler,
  Bc as BoxZoomHandlerMLGL,
  oc as CanvasSource,
  Tc as CanvasSourceMLGL,
  C as ColorRamp,
  ...
  cp as DragRotateHandler,
  up as EdgeInsets,
  np as Evented,
  oi as FullscreenControl,
  Dc as FullscreenControlMLGL,
  ic as GeoJSONSource,
  ...
  Tp as MapStyle,
  _p as MapStyleVariant,
  wc as MapTouchEvent,
  Xc as MapTouchEventMLGL,
  bc as MapWheelEvent,
  Kc as MapWheelEventMLGL,
  Cl as MaptilerGeolocateControl,
  xn as MaptilerLogoControl,
  xl as MaptilerNavigationControl,
  Ll as MaptilerProjectionControl,
  Sl as MaptilerTerrainControl,
  tc as Marker,
  Lc as MarkerMLGL,
  rp as MercatorCoordinate,
  Fc as NavigationControMLGL,
  ti as NavigationControl,
  lp as Point,
  nc as Popup,
  Ac as PopupMLGL,
  wr as RadialGradientLayer,
  ...
  dc as TerrainControl,
  vc as TwoFingersTouchPitchHandler,
  Hc as TwoFingersTouchPitchHandlerMLGL,
  yp as TwoFingersTouchRotateHandler,
  hp as TwoFingersTouchZoomHandler,
  fp as TwoFingersTouchZoomRotateHandler,
  cc as VectorTileSource,
  Rc as VectorTileSourceMLGL,
  pc as VideoSource,
  zc as VideoSourceMLGL,
  Cp as addProtocol,
  xp as addSourceType,
  Pp as areSameLanguages,
  Rp as bufferToPixelDataBrowser,
  zp as circumferenceAtLatitude,
  ip as clearPrewarmedResources,
  D as config,
  Wc as configMLGL,
  Fp as coordinates,
  ...
  Bp as getBufferToPixelDataParser,
  qp as getLanguageInfoFromCode,
  Gp as getLanguageInfoFromFlag,
  Vp as getLanguageInfoFromKey,
  Yc as getMapLibreVersion,
  vp as getMaxParallelImageRequests,
  Qc as getRTLTextPluginStatus,
  Hp as getTileCache,
  kc as getVersion,
  Ho as getWebGLSupportError,
  ...
  Kp as isLanguageInfo,
  oo as kml,
  Xp as mapStylePresetList,
  Zp as math,
  Wp as misc,
  op as prewarm,
  Lp as removeProtocol,
  bp as setMaxParallelImageRequests,
  Jc as setRTLTextPlugin,
  gp as setWorkerCount,
  Sp as setWorkerUrl,
  Yp as staticMaps,
  un as str2xml,
  Jp as styleToStyle,
  Qp as toLanguageInfo,
  sa as xml2str
};
